	...
	<div class="section sec_about">
		...
		<div class="about_timeline column">
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				<div class="timeline_left timeline_2011left">
					<div class="timeline_txt" style="padding-top:90px">
						<p><strong>Fred & Farid Group won and produced 
international campaigns 
for more than 90 brands, including prestigious iconic brands like Van Cleef & Arpels, 
Yves Saint Laurent, Giorgio Armani, Mont Blanc, Wrangler, Martini, 1664, Audi, Orangina… etc.</strong></p>
						<p>The team is chosen by the most serious and respected names in the business:</p>
						<p>Frederic Oudea (CEO Société Générale), Jean-Paul Agon (CEO L’Oréal), Renzo Rosso (CEO Diesel), Jean-Paul Constant (International Brands Director Oxylane Group), Jean-Paul Torris (Vice President Bongrain SA), Philippe Benacin, (CEO Interparfums).</p>
						<p><img src="../images/timeline_2009img.jpg"></p>
					</div>
				</div>
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
					<div class="timeline_txt ">
						<p>Loïc Le Meur asked them to imagine the logo and branding of his influential LeWeb Tech Conference.</p>
						<p style="padding-top:110px;font-size:36px;text-transform: uppercase;line-height:40px;color:#000">Fred & Farid won the highly desired Cannes Lions Grand Prix for their iconic American brand Wrangler, a crowning achievement for every creative in the advertising industry.</p>
						<p>“Before, the brand was about middle-aged cowboy jeans from America. Now it takes a whole look overnight” </p>
						<p>David Lubars<br />President of Cannes Lions Festival</p>
					</div>
				</div>
			</div>
			<!--  -->
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				<div class="timeline_left timeline_2011left">
					<div class="timeline_txt" style="padding-top:30px">
						<p style="font-size:36px;text-transform: uppercase;line-height:40px;color:#000">“Fred & Farid, a duo who became logo” </p>
						<p>27 February 2007<br />Le Monde</p>
						<p><img src="../images/timeline_2007img.jpg"></p>
					</div>
				</div>
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
					<div class="timeline_txt ">
						<p>A new big chapter started, when French financial tycoon Vincent Bolloré offered to finance their own group, Fred & Farid Group. “Fred & Farid are so talented that it was a too good opportunity to pass up” Vincent Bolloré / Campaign (13 Oct 2006).</p>
						<p style="padding-top:80px">Founders, CEO and Executive Creative Directors Fred Raillard and Farid Mokart own 70% of their company. The independent digital group started winning some fiercely sought-after clients like L’Oréal-Diesel, Société Générale, Schweppes, Audi… making the largest growth in the market in the last 5 years, with a turnover of nearly 50 million € in 2011. Fred & Farid have done one of the biggest worldwide buzz by hijacking the Rugby World Cup 2007 with their “Dim Dim Girls” for French underwear brand Dim.</p>
					</div>
				</div>
			</div>
			<!--  -->
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				...
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
					<div class="timeline_txt ">
						<p>At that stage, the team was world-renowned, British newspaper Independent wrote: </p>
						<p style="padding-top:20px;font-size:36px;text-transform: uppercase;line-height:40px;color:#000">“If you’re interested in advertising creativity then you’ll be familiar with Fred & Farid (…) Fred & Farid have a formidable international reputation”.</p>
						<p>16 October 2006</p>
						<p>Indepedent newspaper</p>
					</div>
				</div>
			</div>
			<!--  -->
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				<div class="timeline_left timeline_2011left">
					<div class="timeline_txt" style="padding-top:220px">
						<p>Then Fred & Farid won 17 new accounts in just 18 months, including what French business newspaper Les Echos called “the pitch of the decade” for Internet/mobile Company Orange, leading the image of this European leader in 27 countries.</p>
					</div>
				</div>
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
					<div class="timeline_txt ">
						<p><strong>In 2005, Publicis Group chairman Maurice Levy personally hired “the already legendary advertising duo” to launch Marcel, a new international digital agency based in Paris, named after the founder of Publicis’ group, Bleustein-Blanchet. </strong></p>
						<p>18 June 2005</p>
						<p>Maurice Levy<br />Paris Match</p>
					</div>
				</div>
			</div>
			<!--  -->
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				<div class="timeline_left timeline_2011left">
					<div class="timeline_txt" style="padding-top:20px">
						<p><strong>New York magazine  </strong><br />“Their work for Pepsi and Xbox in Europe made them the ad-world’s Spike Jonze”.</p>
						<p>21 July 2003</p>
					</div>
				</div>
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				<div class="timeline_left timeline_2011left">
					<div class="timeline_txt" style="padding-top:130px">
						...
						<p>Their Gold Lion spot XBOX Campagne found itself "Grand Prix finalist" in Cannes in 2002, facing Nike Play. </p>
						<p style="text-transform: uppercase;font-size:18px;color:#000;font-weight:bold">"This is one of the best spots I've seen all year. Everything about it is great. It should win the Palm" </p>
						<p>June 06th 2002</p>
						<p>David Lubbars<br />Shots </p>
					</div>
					<div class="timeline_txt" style="padding-top:20px">
						<p><strong style="color:#000;display:block;text-transform: uppercase;">Shots Magazine </strong>
							Fred & Farid became "Le tout Soho's favourite Gallic creative team"</p>
						<p style="font-size:14px">14 August 2002</p>
						<p><strong style="color:#000;display:block;text-transform: uppercase;">Creative review</strong>
						...
						<p style="font-size:14px">14 November 2002</p>
						<p><strong style="color:#000;display:block;text-transform: uppercase;">strategie</strong>
							"The two Zidanes of the French advertising creation"</p>
						<p style="font-size:14px">14 November 2002</p>
					</div>
					<div class="timeline_txt" style="padding-top:80px">
						<p>In 2002, the American advertising star Jeff Goodby hired them at Goodby Silverstein & Partners in San Francisco where they launched Netflix in USA and UK, and relaunched the iconic athletic brand Pony in 180 countries.</p>
						<p style="text-transform: uppercase;font-size:18px;color:#000;font-weight:bold"> "They have a simpler way of looking at things, of wiping away the marketing drivel that people tend to be caught up in. They have a way of getting past that to thinking in big breathtaking ways about products" </p>
						<p>November 2002</p>
						<p>Jeff Goodby<br />CR Creative Review</p>
					</div>
				</div>
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
					<div class="timeline_txt ">
						<p>Advertising legend Sir John Hegarty hired them at the prestigious BBH London to lead the biggest Microsoft launch: XBOX (500 million dollars). </p>
						<p style="padding-top:20px;font-size:36px;text-transform: uppercase;line-height:40px;color:#000">"Fred & Farid have a huge talent. They know how to develop a narrative structure from an audacious idea"  </p>
						<p >February 08th 2002</p>
						<p >Sir John Hegarty <br />Stratégies</p>
						<p  style="padding-top:390px;text-transform: uppercase;font-size:18px;color:#000;font-weight:bold"><strong>In his 2002 novel "L'Egoiste romantique", famous French writer Frederic Beigbeder mentioned them as "Fred & Farid, the world's best advertising creatives".</strong></p>
						<p >06 June 2002</p>
						<p >Fredeirc Beigbeder<br />L’Egoiste romatique</p>
			...
			<div data-effect="fadeup" class="timeline_item intoview-effect cs-clear">
				...
				<div class="timeline_right timeline_2011right" style="padding-top:20px">
					<div class="timeline_txt ">
						<p style="text-transform: uppercase;font-weight:bold;color:#000">Fred & Farid created the famous and controversial musical video of British Pop Star Robbie Williams "Rock DJ" which won a Brit Award and an MTV award in the USA.</p>
						<p><img src="../images/timeline_2000img2.jpg"></p>
						<p><strong style="color:#000;display:block;text-transform: uppercase;">Shots Magazine (61) </strong>
							Chose the French team to start their gallery of the <br />12 best creative teams in the world </p>
						<p style="font-size:14px">November 12th 2000</p>
						<p>Then they embarked on an International career. At that time, Fred & Farid were the first major French creative team to move abroad and work outside France.</p>
					</div>
				</div>
			</div>
		</div>
